...
namespace QFramework
{
    ...
    public interface IResourcesModule
    {
        ...
        /// 失败重试最大数目。
        /// </summary>
        int FailedTryAgainCount { get; set; }
        ...
        /// 热更链接URL。
        /// </summary>
        string HotfixRemoteServerURL { get; set; }

        /// <summary>
        /// 备用热更URL。
        /// </summary>
        string FallbackHotfixRemoteServerURL { get; set; }

        /// <summary>
        /// 获取或设置资源对象池自动释放可释放对象的间隔秒数。
        /// </summary>
        float AssetObjPoolAutoReleaseInterval { get; set; }

        /// <summary>
        /// 获取或设置资源对象池的容量。
        /// </summary>
        int AssetObjPoolCapacity { get; set; }

        /// <summary>
        /// 获取或设置资源对象池对象过期秒数。
        /// </summary>
        float AssetObjPoolExpireTime { get; set; }

        /// <summary>
        /// 获取或设置资源对象池的优先级。
        /// </summary>
        int AssetObjPoolPriority { get; set; }
        ...
        UniTaskVoid LoadAssetAsync<T>(string location, Action<T> callback, string packageName = "") where T : UnityEngine.Object;
        ...
        /// <param name="location">资源的定位地址。</param>
        /// <param name="packageName">指定资源包的名称。不传使用默认资源包</param>
        public UniTask<T[]> LoadSubAssetsAsync<T>(string location, string packageName = "") where T : UnityEngine.Object;
        ...
        /// <param name="location">资源的定位地址。</param>
        /// <param name="packageName">指定资源包的名称。不传使用默认资源包</param>
        public T[] LoadSubAssetsSync<T>(string location, string packageName = "") where T : UnityEngine.Object;
        ...
        RequestPackageVersionOperation RequestUpdatePackageVersionAsync(bool appendTimeTicks = false, int timeout = 60, string customPackageName = "");
        ...
        /// <param name="customPackageName">指定资源包的名称。不传使用默认资源包</param>
        UpdatePackageManifestOperation RequestUpdatePackageManifestAsync(string packageVersion, int timeout = 60, string customPackageName = "");
